...
export const emailStatusEnum = pgEnum(
  "email_status",
  Object.values(EmailStatus) as [string, ...string[]],
);
export const subscriberStatusEnum = pgEnum(
  "subscriber_status",
  Object.values(SubscriberStatus) as [string, ...string[]],
);
export const formTypeEnum = pgEnum(
  "form_type",
  Object.values(FormType) as [string, ...string[]],
);
...
export const subscribersTags = pgTable(
  "subscribers_tags",
  {
...
export const subscribersTagsRelations = relations(
  subscribersTags,
  ({ one }) => ({
